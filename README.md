...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:daniel.dieser@example.com)
...
- 🤖 **Asistentes de Voz e IA** - Desarrollo de sistemas de procesamiento de lenguaje natural
- 🛡️ **Ciberseguridad** - Web Application Firewalls (WAF) mejorados con IA
- 🌱 **Visión por Computadora** - Detección de plagas en plantas usando Deep Learning
- 🔬 **Investigación** - Aplicación de modelos generativos (ChatGPT) en seguridad
...
### 🛡️ [Web Application Firewall (WAF) Enhanced with AI](https://github.com/daletoniris/Web-Application-Firewall-Purple-AI-Paper)
Sistema de firewall mejorado con IA que combina **Naive Bayes** y **ChatGPT** para detección autónoma de amenazas.

- 🤖 Aprendizaje dinámico autónomo
- 🔄 Retrenamiento continuo
- ⚡ Detección en tiempo real
- 🎯 Protección contra zero-day attacks
...
### 🌱 [Detección de Plagas en Plantas](https://github.com/daletoniris/deteccion-de-plagas-en-plantas-con-tensorflow)
Sistema de detección de plagas usando **TensorFlow** y visión por computadora.

- 🔍 Detección en tiempo real
- 📸 Análisis de imágenes y video
- 🤖 Modelo entrenado con MobileNet
...
### 📱 [Jarvis V2 - Telegram Bot](https://github.com/daletoniris/Jarvis-V2-Telegram)
Asistente de voz mejorado con integración de Telegram.
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=daletoniris&show_icons=true&theme=radical&hide_border=true&bg_color=0D1117&title_color=4ECDC4&icon_color=4ECDC4&text_color=9f9f9f&hide_title=false)
...
- 🥇 **Primer asistente de voz en español** (JarvisIA)
- 📄 **Paper publicado** sobre WAF mejorado con IA
- 🌍 **Fomento del desarrollo de IA en Latinoamérica**
- 👨‍🏫 **Mentor** de estudiantes de programación y hacking
- 🤝 **Colaborador** en @initiasur, @NiperiaLab
...
- 🔬 Investigación en IA y modelos generativos
- 🛡️ Ciberseguridad y análisis de vulnerabilidades
- 🤖 Robótica y sistemas autónomos
- 🌱 AgTech - Aplicación de IA en agricultura
- 🎓 Educación en programación y hacking ético
...
- **@initiasur** - Iniciativas de investigación
- **@NiperiaLab** - Laboratorio de investigación
- **Tokio AI Security Research, Inc** - Investigación en seguridad
...
[![Email](https://img.shields.io/badge/Email-me-blue?style=for-the-badge&logo=gmail)](mailto:daniel.dieser@example.com)
